...
import com.configuration.helper.File_Reader_Adactin;
...
public class Adactin_Runner extends Base_class{
	...
	PropertyConfigurator.configure("log4j.properties");
	    ...
	    String url = File_Reader_Adactin.get_instance_adactin_FRM().get_instance_adactin_CR().get_adactin_url();
	    geturl(url);
	    ...
	    String username = File_Reader_Adactin.get_instance_adactin_FRM().get_instance_adactin_CR().get_adactin_username();
	    invalueelement(pom.getinstance_hp().getUser(),username);
		
		String pass = File_Reader_Adactin.get_instance_adactin_FRM().get_instance_adactin_CR().get_adactin_pass();
		invalueelement(pom.getinstance_hp().getPass(), pass);
		
		
		String login = File_Reader_Adactin.get_instance_adactin_FRM().get_instance_adactin_CR().get_adactin_login();
